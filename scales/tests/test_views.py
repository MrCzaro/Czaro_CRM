...
class CreatePatientBmiViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:bmi_create", args=[self.patient.id, self.hospitalization.id]
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/bmi-add/",
        )
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                ...
                args=[
                    self.patient.id,
                    self.hospitalization.id,
                    self.body_mass_index.id,
                ],
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/bmi-edit/{self.body_mass_index.id}/",
        )
...
class CreateGlasgowScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:glasgow_create", args=[self.patient.id, self.hospitalization.id]
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/glasgow-add/",
        )
...
class UpdateGlasgowScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:glasgow_update",
                args=[self.patient.id, self.hospitalization.id, self.glasgow.id],
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/glasgow-edit/{self.glasgow.id}/",
        )
...
class CreateNewsScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:news_create", args=[self.patient.id, self.hospitalization.id]
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/news-add/",
        )
...
class UpdateNewsScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:news_update",
                args=[self.patient.id, self.hospitalization.id, self.news.id],
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/news-edit/{self.news.id}/",
        )
...
class CreateNortonScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:norton_create", args=[self.patient.id, self.hospitalization.id]
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/norton-add/",
        )
...
class UpdateNortonScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:norton_update",
                args=[self.patient.id, self.hospitalization.id, self.norton.id],
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/norton-edit/{self.norton.id}/",
        )
...
class CreatePainScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:pain_create", args=[self.patient.id, self.hospitalization.id]
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/pain-add/",
        )
...
class UpdatePainScaleViewTest(TestCase):
    ...
    def test_authentication_required(self):
        response = self.client.get(
            reverse(
                "scales:pain_update",
                args=[self.patient.id, self.hospitalization.id, self.pain.id],
            )
        )
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response,
            f"/login/?next=/scale/{self.patient.id}/{self.hospitalization.id}/pain-edit/{self.pain.id}/",
        )
