...
class NewsScaleFormTest(TestCase):
    ...
    def test_oxygen_saturation_label(self):
        form = NewsScaleForm()
        self.assertEqual(form.fields["oxygen_saturation"].label, "Oxygen saturation level")
    ...
    def test_aecopd_state_label(self):
        form = NewsScaleForm()
        self.assertEqual(form.fields["aecopd_state"].label, "Is the patient in Acute exacebrations of chronic obstructive pulmonary disease state")
    ...
    def test_systolic_blood_pressure_label(self):
        form = NewsScaleForm()
        self.assertEqual(form.fields["systolic_blood_pressure"].label, "Systolic blood presurre")
              
    def test_diastolic_blood_pressure_label(self):
        form = NewsScaleForm()
        self.assertEqual(form.fields["diastolic_blood_pressure"].label, "Diastolic blood pressure")
    ...
    def test_level_of_consciousness_label(self):
        form = NewsScaleForm()
        self.assertEqual(form.fields["level_of_consciousness"].label, "Level of consciousness")
