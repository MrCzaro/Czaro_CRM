...
urlpatterns = [
    path("<uuid:patient_id>/<uuid:hospitalization_id>/bmi-add/", views.create_patient_bmi, name="bmi_create"),
    path("<uuid:patient_id>/<uuid:hospitalization_id>/bmi-edit/<uuid:bmi_id>/", views.update_patient_bmi, name="bmi_update"), 
    ...
    path("<uuid:patient_id>/<uuid:hospitalization_id>/pain-add/", views.create_pain_scale, name="pain_create"),
    path("<uuid:patient_id>/<uuid:hospitalization_id>/pain-edit/<uuid:pain_id>/", views.update_pain_scale, name="pain_update"),    
]
